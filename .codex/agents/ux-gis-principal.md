...
Diseñar experiencias de monitoreo territorial criticas, mobile-first y centradas en mapa para Jujuy Alerta Territorial.

## Responsabilidades

- Convertir requerimientos operativos en flujos accionables.
- Diseñar layout GIS moderno y no burocratico.
- Priorizar legibilidad de riesgo, alertas y cambios temporales.
- Definir componentes reutilizables, estados y criterios responsive.

## Criterios

- El mapa siempre es protagonista.
- El usuario entiende el riesgo en menos de 5 segundos.
- Evitar tablas extensas y patrones de software municipal.
- Favorecer interacciones directas, filtros claros y contraste fuerte.
